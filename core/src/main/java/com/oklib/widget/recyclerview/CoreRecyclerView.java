package com.oklib.widget.recyclerview;
...
import com.oklib.widget.recyclerview.observer.ViewDataObserver;
...
public class CoreRecyclerView extends FrameLayout {
    ...
    protected void initAttrs(AttributeSet attrs) {
        //加载attr属性
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.CoreRecyclerView);
        try {
            mClipToPadding = a.getBoolean(R.styleable.CoreRecyclerView_recyclerClipToPadding, false);
            mPadding = (int) a.getDimension(R.styleable.CoreRecyclerView_recyclerPadding, -1.0f);
            mPaddingTop = (int) a.getDimension(R.styleable.CoreRecyclerView_recyclerPaddingTop, 0.0f);
            mPaddingBottom = (int) a.getDimension(R.styleable.CoreRecyclerView_recyclerPaddingBottom, 0.0f);
            mPaddingLeft = (int) a.getDimension(R.styleable.CoreRecyclerView_recyclerPaddingLeft, 0.0f);
            mPaddingRight = (int) a.getDimension(R.styleable.CoreRecyclerView_recyclerPaddingRight, 0.0f);
            mScrollbarStyle = a.getInteger(R.styleable.CoreRecyclerView_scrollbarStyle, -1);
            mScrollbar = a.getInteger(R.styleable.CoreRecyclerView_scrollbars, -1);
            mEmptyId = a.getResourceId(R.styleable.CoreRecyclerView_layout_empty, 0);
            mProgressId = a.getResourceId(R.styleable.CoreRecyclerView_layout_progress, 0);
            mErrorId = a.getResourceId(R.styleable.CoreRecyclerView_layout_error, 0);
        } finally {
            a.recycle();
        }
    }
    ...
    protected void initRecyclerView(View view) {
        mRecyclerView = view.findViewById((R.id.core_recyclerview));
