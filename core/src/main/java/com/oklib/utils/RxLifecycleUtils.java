...
import com.oklib.base.lifecycle.Lifecycleable;
...
public class RxLifecycleUtils {
     ...
     * @return
     */
    public static <T> LifecycleTransformer<T> bindUntilEvent(@NonNull final CoreBaseView view,
     ...
     * @return
     */
    public static <T> LifecycleTransformer<T> bindToLifecycle(@NonNull CoreBaseView view) {
        Preconditions.checkNotNull(view, "view == null");
