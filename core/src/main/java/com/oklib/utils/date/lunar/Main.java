package com.oklib.utils.date.lunar;
...
public class Main {
    ...
    public static void main(String[] args) {
        // Basic
        LunarCalendar lunarCalender = LunarCalendar.obtainCalendar(2019, 2, 25);
        System.out.println(lunarCalender.getDay());
        System.out.println(lunarCalender.getFullLunarStr());
        System.out.println(lunarCalender.getLunar().year);
        System.out.println(lunarCalender.getLunar().month);
        System.out.println(lunarCalender.getLunar().day);
        println();
